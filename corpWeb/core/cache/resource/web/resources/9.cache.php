<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1543391311,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1543391311,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
                    ...
                    <div class="col-12">
                      ...
                      <div class="row">
                        <div class="col-10 col-xl-8 col-lg-8 col-md-8 mx-auto">
                          <div class="row">
                            <div class="col-8">
                              <h1 class="glitch" data-text="CISCO PARTNERDAY">CISCO PARTNERDAY</h1>
                            </div>
                          </div>
                          <!-- Отступ -->
                          <div class="row">
                          ...
                          <!------------>
                          <div class="row">
                            <div class="col-12 col-xl-6 mb-4 news_one_new_text">
                              <p class="text-justify">
                                Наша компания посетила мероприятие «Партнерская конференция CISCO PartnerDay». Это ежегодная партнерская конференция, посвященная обзору новинок и самых актуальных решений Cisco, которая состоялась 06 октября в отеле Ренессанс в Минске. Эксперты Cisco рассказали об актуальных тенденциях ИТ-рынка, поделились мнением о том, какие инновации определят будущее и какие технологии являются важным условием успеха бизнеса.
                              </p>
                            </div>
                            <div class="col-12 col-xl-6 one_new_video">
                              <iframe width="100%" src="https://www.youtube.com/embed/JIdCpjJv02I" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-10 col-md-8 mx-auto">
                          ...
                          <div class="row">
                            <div class="col-8 my-4">
                              <h2 class="one_new_photo_title glitch" data-text="Фотоотчёт">Фотоотчёт</h2>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-12 mt-4 mb-0">
                              <div class="row" id="one_new_gellery">
                                <div class="col-12 col-md-4 px-1 py-1" data-src="images/news/cisco/img1.jpg">
                                  <div class="one-new-photo">
                                    <img class="img-responsive" src="images/news/cisco/img1.jpg" alt="cisco" titel="cisco">
                                  </div>
                                </div>
                                <div class="col-12 col-md-4 px-1 py-1" data-src="images/news/cisco/img2.jpg">
                                  <div class="one-new-photo">
                                   <img class="img-responsive" src="images/news/cisco/img2.jpg" alt="cisco" titel="cisco">
                                  </div>
                                </div>
                                <div class="col-12 col-md-4 px-1 py-1" data-src="images/news/cisco/img3.jpg">
                                  <div class="one-new-photo">
                                    <img class="img-responsive" src="images/news/cisco/img3.jpg" alt="cisco" titel="cisco">
                                  </div>
                                </div>
                              
                                <div class="col-12 col-md-4 px-1 py-1" data-src="images/news/cisco/img4.jpg">
                                  <div class="one-new-photo">
                                    <img class="img-responsive" src="images/news/cisco/img4.jpg" alt="cisco" titel="cisco">
                                  </div>
                                </div>
                                <div class="col-12 col-md-4 px-1 py-1" data-src="images/news/cisco/img4.jpg">
                                  <div class="one-new-photo">
                          ...
                          <div class="row">
                            <div class="col-12 mt-4 mb-0">
                              ...
                              <div class="row">
                                <div class="col-12 mx-auto mx-md-0 col-md-6 align-self-end text-right px-1 my-4">
                                  <a href="novosti"><button type="button" class="btn news-more">Вернуться к новостям</button></a>
                                </div>
                              </div> 
