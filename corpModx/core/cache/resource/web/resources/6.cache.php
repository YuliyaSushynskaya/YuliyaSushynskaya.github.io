<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1543389022,
    'editedby' => 1,
    'editedon' => 1543389025,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1543389000,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="en">
  ...
  <body>
    ...
    <!-- POP-UP 1 quickcall -->
              <div id="modal-container-quickcall">
                <div class="modal-background-quickcall">
                  <div class="modal-quickcall">
                    <div class="popup_close" id="close_quickcall">
                        Закрыть
                      ...
                      <div class="col-12">
                        <div class="row">
                          <div class="col-12 mx-auto text-left">
                            <h2 id="contacts_title" class="text-center">Быстрый звонок</h2>
                            <h5 id="contacts_text" class="my-2 mt-4 text-center">Оставьте контактный номер телефона и мы свяжемся с Вами в удобное для Вас время</h5>
                            <p><iframe id="frame_contacts" class="frame_absolute" name="area_contacts" style="border:0; width: 100%;"></iframe></p>
                            <form class="sevrices_form_one" action="php/form_contacts_validate.php" target="area_contacts" method="POST" name="contactsForm" id="contactsFormID" onsubmit="return validateContacts()">
                              <div class="form-group mt-4 mb-4">
                                  
                                <div class="row">
                                    <div class="col-12 col-lg-6 mx-auto">
                                        <p class="my-2">В какое время Вам перезвонить?</p>
                                        <select class="form-control form-control-lg" name="time" form="contactsFormID">
                                            <option value="anytime" selected>в любое время</option>
                                            <option value="9-10">с 9 - до 10</option>
                                            <option value="10-11">с 10 - до 11</option>
                                            <option value="11-12">с 11 - до 12</option>
                                            <option value="12-13">с 12 - до 13</option>
                                            <option value="13-14">с 13 - до 14</option>
                                            <option value="14-15">с 14 - до 15</option>
                                            <option value="15-16">с 15 - до 16</option>
                                            <option value="16-17">с 16 - до 17</option>
                                            <option value="17-18">с 17 - до 18</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-12 col-md-6">
                                    ...
                                    <input id="phone_contact" class="form-control form-control-lg" name="phone" form="contactsFormID" type="text" placeholder="(XXX)XXX-XXXX">
                                  </div>
                                  <div class="col-12 col-md-6">
                                    <p class="my-2" style="opacity: 0">Телефон для связи</p>
                                    <button type="submit" class="btn contacts_send_quickcall">Отправить</button>
                                  </div>
                                </div>
                              </div>
                            </form>
...
<!-- ПОДВАЛ -->
                ...
                <div class="col-12 bypro_first_block services_content_wrapper" id="services_content_wrapper_ID">
                    ...
                    <div class="col-12">
                      ...
                      <div class="row">
                        <div class="col-10 col-xl-8 col-lg-8 col-md-8 mx-auto">
                          <div class="row">
                            <div class="col-6">
                              <h1 class="glitch" data-text="Контакты">Контакты</h1>
                            </div>
                          </div>
                          <!-- Отступ -->
                          <div class="row">
                          ...
                          <!------------>
                          <div class="row">
                            <div class="col-12 mt-4 mt-xl-0 col-xl-6 order-2 order-xl-1 news_one_new_text">
                              <p class="text-justify">
                                Связаться с нами можно всегда, просто, и быстро. Специалисты нашей компании готовы ответить на любые Ваши вопросы, в том числе технического характера.
                                Бесплатная круглосуточная консультация доступна для всех юридических лиц (даже не клиентов нашей компании). 
                                Кроме этого Вы можете отправить сообщение через форму быстрой связи и наши специалисты свяжутся с Вами в удобное для Вас время.
                              </p>
                            </div>
                            <div class="col-12 col-xl-6 order-1 order-xl-2">
                              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2350.631511137584!2d27.51290381620905!3d53.90275318009947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46dbc557b87e68cf%3A0x341f626be83bcb9!2z0YPQuy4g0JPRg9GB0L7QstGB0LrQvtCz0L4gMTAsINCc0LjQvdGB0Lo!5e0!3m2!1sru!2sby!4v1519205737783" width="100%" height="250" frameborder="0" style="border:0" allowfullscreen=""></iframe>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row">
                        <div class="col-10 mx-auto col-md-8 ml-xl-auto">
                          <div class="row">
                            <div class="col-12 mx-auto col-xl-8 ml-xl-auto order-2 order-xl-1 contacts_contacts">
                              <h2 class="mb-4">Телефоны</h2>
                              <div class="row">
                             
                                    <div class="col-12 col-md-6 contacts_telephones">
                                      <p class="my-3">
                                        +375(17) 342-08-08
                                        <a href="tel:+375(17) 342-08-08"><span class="float-right d-inline-block d-md-none contacts_quickcall_span text-center">
                                          <i class="fa fa-phone" aria-hidden="true"></i>
                                        </span></a>
                                      </p>
                                      <p class="my-3">
                                        +375(17) 343-08-08
                                        <a href="tel:+375(17) 343-08-08"><span class="float-right d-inline-block d-md-none contacts_quickcall_span text-center">
                                          <i class="fa fa-phone" aria-hidden="true"></i>
                                        </span></a>
                                      </p>
                                    </div>
                                    <div class="col-12 col-md-6 contacts_telephones">
                                      <p class="my-3">
                                        +375(44) 733-20-41 <span class="contacts_vel d-none">[vel]</span>
                                        <a href="tel:+375(44) 733-20-41"><span class="float-right d-inline-block d-md-none contacts_quickcall_span text-center">
                                          <i class="fa fa-phone" aria-hidden="true"></i>
                                        </span></a>
                                      </p>
                                      <p class="my-3">
                                        +375(29) 851-85-72 <span class="contacts_mts d-none">[mts]</span>
                                        <a href="tel:+375(29) 851-85-72"><span class="float-right d-inline-block d-md-none contacts_quickcall_span text-center">
                                          <i class="fa fa-phone" aria-hidden="true"></i>
                                        </span></a>
                                      </p>
                                    </div>
                            ...
                            <div class="col-10 mx-auto col-xl-4 ml-xl-auto order-1 order-xl-2">
                              <h2 class="mb-4" style="opacity: 0">Быстрая связь</h2>
                              <button class="btn news-more contacts_button_quickcall" id="quickcall">Быстрая связь</button>
                                  <!-- Отступ -->
                  ...
                  <!------------>
                    ...
                    <!-- Круглосуточная поддержка -->
                          ...
                          <div class="row">
                               <div class="col-10 mx-auto col-md-8 ml-xl-auto order-0 order-xl-1 contacts_contacts">
                                  <h2 class="mb-4 glitch" style="color: #c5004a;" data-text="КРУГЛОСУТОЧНАЯ ПОДДЕРЖКА">Круглосуточная поддержка</h2>
                                  <div class="row">
                                 
                                        <div class="col-12 col-md-6 contacts_telephones">
                                          <p class="my-3">
                                           +375(29) 285-08-08 [MTС]
                                            <a href="tel:+375(29) 285-08-08"><span class="float-right d-inline-block d-md-none contacts_quickcall_span text-center">
                                              <i class="fa fa-phone" aria-hidden="true"></i>
                                            </span></a>
                                          </p>
                                          <p class="my-3">
                                            +375(29) 385-08-08 [Velcom]
                                            <a href="tel:+375(29) 385-08-08"><span class="float-right d-inline-block d-md-none contacts_quickcall_span text-center">
                                              <i class="fa fa-phone" aria-hidden="true"></i>
                                            </span></a>
                                          </p>
                                        </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row">
                        <div class="col-10 mx-auto col-md-8 ml-xl-auto contacts_contacts">
                          <div class="row">
                            <div class="col-10 col-xl-6">
                              <h2 class="mb-4">Наш адрес</h2>
                              <p class="text-justify mt-4">
                                Республика Беларусь, г. Минск, ул. Гусовского, д.10, помещение №9 (оф. № 504)
                              </p>
                            </div>

                            <!-- Отступ -->
                              <div class="col-12 mt-4 mb-4 d-block d-xl-none"></div>
                            <!------------>

                            <div class="col-12 col-md-10 col-xl-4 ml-xl-auto">
                              <h2 class="mb-4">Наша почта</h2>
                              <p class="text-justify mt-4">
                                e-mail: office@bypro.by
                                <a href="mailto:office@bypro.by"><span class="float-right d-inline-block d-md-none contacts_quickcall_span text-center">
   ...
   <!-- jQuery first, then Popper.js, then Bootstrap JS -->
    ...
    <script src="js/popup-quickcall.js"></script>
