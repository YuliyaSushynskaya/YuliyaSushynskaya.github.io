<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1543389044,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1543389044,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
                    ...
                    <div class="col-12">
                      ...
                      <div class="row">
                        <div class="col-10 col-xl-8 col-lg-8 col-md-8 mx-auto">
                          <div class="row">
                            <div class="col-8">
                              <h1 class="glitch" data-text="Новости">Новости</h1>
                            </div>
                          </div>
                          <!-- Отступ -->
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-12 col-xl-8 col-lg-8 col-md-12">
                              <p class="text-justify">
                                 Сфера информационных технологий в наше время развивается стремительно. Каждый день появляются новые технологии следить за которыми обязан каждый специалист.
                                 Находиться в курсе последних нововведений стремится и наша компания. Наши сотрудники регулярно посещают самые актуальные мероприятия и форумы связанные с нашей профессиональной
                                 деятельностью. 
                              </p>
                            </div>
                        ...
                        <div class="col-10 col-xl-8 col-lg-8 col-md-8 mx-auto">
                          ...
                          <div class="row">
                            <div class="col-12 col-xl-8 col-lg-8 col-md-8 my-4">
                              <h2 class="news_one_new_h2 glitch" data-text="CISCO PARTNERDAY">CISCO PARTNERDAY</h2>
                            </div>
                          </div>

                          <!-- Заголовок и анонс -->
                          <div class="row">
                            <div class="col-12 col-xl-8 order-lg-2 order-xl-1 mb-4 news_one_new_text">
                              <p class="text-right my-4">Партнерская конференция CISCO PartnerDay</p>
                              <p class="text-justify my-4">
                                Наша компания посетила мероприятие «Партнерская конференция CISCO PartnerDay». Это ежегодная партнерская конференция, посвященная обзору новинок и самых актуальных решений Cisco, которая состоялась 06 октября в отеле Ренессанс в Минске.
                              </p>
                            </div>
                            <!-- Картинка -->
                            <div class="col-12 col-xl-4 col-lg-8 px-1 order-lg-1 order-xl-2 d-none d-lg-block">
                              <div class="news-announcement-image-wrapper">
                                <video autoplay="autoplay" loop="" muted="" preload="auto" src="video/Cisco.mp4">&nbsp;</video>
                              </div>
                            </div>

                            <div class="col-12 col-xl-4 col-lg-8 px-1 order-lg-1 order-xl-2 d-block d-lg-none">
                              <div class="news-announcement-image-wrapper">
                                <iframe width="100%" height="290" src="https://www.youtube.com/embed/BdmNipDkeO8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-12 mt-2 mb-0">
                              <div class="row">
                                <div class="col-6 col-lg-6 col-xl-3 my-md-1 my-lg-1 my-0 px-1 d-none d-md-block">
                                  <div class="news-preview-gallery" style="background-image: url(\'images/news/cisco/img1.jpg\')">

                                  </div>
                                </div>
                                <div class="col-6 col-lg-6 col-xl-3 my-md-1 my-lg-1 my-0 px-1 d-none d-md-block">
                                  <div class="news-preview-gallery" style="background-image: url(\'images/news/cisco/img2.jpg\')">

                                  </div>
                                </div>
                                <div class="col-6 col-lg-6 col-xl-3 my-md-1 my-lg-1 my-0 px-1 d-none d-md-block">
                                  <div class="news-preview-gallery" style="background-image: url(\'images/news/cisco/img3.jpg\')">

                                  </div>
                                </div>
                                <div class="col-6 col-lg-6 col-xl-3 my-md-1 my-lg-1 my-0 px-1 d-none d-md-block">
                                  <div class="news-preview-gallery" style="background-image: url(\'images/news/cisco/img4.jpg\')">
                          ...
                          <!-- Подробнее -->
                          <div class="row">
                            <div class="col-8 col-lg-4 mx-auto mx-lg-0 align-self-end text-right px-1 my-4">
                              <a href="odna-novost"><button type="button" class="btn news-more">Подробнее</button></a>
                            </div>
                          </div> 
