<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1543388906,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1543388906,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    <!--=== CONTENT ===-->
        <content>
            <div class="col-12 col-xl-10 col-lg-10 float-xl-right float-lg-right bypro_content_wrapper">
                                    ...
                                    <div class="services_submenu products">
                                      <ul>
                                        <li class="my-4 my-lg-1" name="outsorsing"><p name="outsorsing">Системное администрирование</p><span></span><div class="special_contact active" id="light_outsorsing" name="outsorsing"></div></li>
                                        <li class="my-4 my-lg-1" name="security"><p name="security">Информационная безопасность</p><span></span><div class="special_contact" id="light_security" name="security"></div></li>
                                        <li class="my-4 my-lg-1" name="web"><p name="web">Веб-разработка</p><span></span><div class="special_contact" id="light_web" name="web"></div></li>
                                      </ul>
                                    </div>
...
------------------------------------------------------------------------------------------------------------------------------------------->
<div id="outsorsing_wrapper">           
                  <!-- Описание -->
                  <div class="row">
                    <div class="col-12" name="outsorsing">
                        ...
                        <div class="col-10 col-md-8 mx-auto">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-lg-8">
                                <h1 class="outsorsing"><span style="display:inline-block" class="glitch" data-text="Системное">Системное </span> <span style="display:inline-block" class="glitch" data-text="администрирование">администрирование</span></h1>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-4 d-none d-lg-block"></div>
                              <div class="col-12 col-lg-8 services_description">
                                <ul class="chip">
                                  <li><span>компьютерного оборудования</span></li>
                                  <li><span>переферийного оборудования</span></li>
                                  <li><span>сетевого оборудования</span></li>
                                </ul>
                              </div>
                            </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row mt-0 mt-md-4 mb-4">
                        <div class="col-11 col-md-8 mx-auto services_list_of_service">
                          <div class="row">
                            <div class="col-12 col-xl-4 mt-4 mt-xl-0 mb-4 mb-xl-0">
                              <h5 class="mb-4">Консультация и выезд на объект</h5> 
                              <ul>  
                                <li>Консультирование по телефону и электронной почте</li>
                                <li>Выезд исполнителя к месту нахождения оборудования</li>
                                <li>Срочнй выезд Исполнителя по эктренному вызову</li>
                                <li>Квалифицированное консультирование Заказчика по вопросам приобретения оборудования</li>
                                <li>Удалённое администрирование</li>
                              </ul>
                            </div>
                            <div class="col-12 col-xl-4 mt-4 mt-xl-0 mb-4 mb-xl-0">
                              <h5 class="mb-4">Подключение и поддержка</h5> 
                              <ul> 
                                <li>Подключение и настройка рабочих мест пользователей</li>
                                <li>Настройка принтеров, сканеров и других периферийных устройств</li>
                                <li>Поддержка прокси-сервера и организация совместного доступа в Internet</li> 
                                <li>Предоставление и разграничение доступа к общим ресурсам</li>
                                <li>Поддержка VPN-сервера</li>
                              </ul>
                            </div>
                            <div class="col-12 col-xl-4 mt-4 mt-xl-0 mb-4 mb-xl-0">
                              <h5 class="mb-4">Установка и настройка</h5>
                              <ul>  
                                <li>Установка и настройка лицензионного ПО</li>
                                <li>Установка и настройка лицензионного антивирусного ПО</li>
                                <li>Установка, настройка, сопроводжение специального прикладного ПО</li>
                                <li>Установка, настройка и поддержка почтовых серверов и клиентов</li>
                                <li>Установка, настройка иподдержка северов на базе Windows</li>
                              </ul>
                            </div>
                          </div>
                        </div>
...
<!-----------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------- END СИСТЕМНОЕ АДМИНИСТРИРОВАНИЕ ---------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------->
                  <div class="row">
...
<div  id="security_wrapper">
                  <!-- Описание -->
                  <div class="row">
                    <div class="col-12" name="secutity">
                      ...
                      <div class="row">
                        <div class="col-10 col-md-8 mx-auto">
                            ...
                            <div class="row">
                              <div class="col-4 d-none d-lg-block"></div>
                              <div class="col-12 col-lg-8">
                                <h1 class="security"><span style="display:inline-block" class="glitch" data-text="Информационная">Информационная </span> <span style="display:inline-block" class="glitch" data-text="безопасность">безопасность</span></h1>
                              </div>
                            </div>
...
<!-----------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------- END ИНФОРМАЦИОННАЯ БЕЗОПАСНОСТЬ -----------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------->
                  <div class="row">
                    <div class="col-12 my-4 d-none d-md-block"></div>
                    <div class="col-12 my-4 d-none d-xl-block"></div>
                      ...
                      <div class="row">
                        <div class="col-10 col-md-8 mx-auto">
                            ...
                            <div class="row">
                              <div class="col-4 d-none d-lg-block"></div>
                              <div class="col-12 col-lg-8">
                                <h1 class="web glitch" data-text="Веб разработка">Веб разработка</h1>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-lg-8 services_description">
                                <ul>
                                  ...
                                  <li><span>Наполнение</span></li>
                                  <li><span>Разработка</span></li>
                                </ul>
                              </div>
                            </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="row mt-0 mt-md-4 mb-4">
                        <div class="col-11 col-md-8 mx-auto services_list_of_service">
                          <div class="row">
                            <div class="col-12 col-xl-4 mt-4 mt-xl-0 mb-4 mb-xl-0">
                              <h5 class="mb-4">Дизайн и фирменный стиль</h5> 
                              <ul>  
                                <li>Разработка логотипов и баннеров</li>
                                <li>Создание брендбуков</li>
                                <li>Дизайн макетов страниц сайта</li>
                                <li>Отрисовка прототипов страниц сайта</li>
                              </ul>
                              
                              <h5 class="my-4">Комплексное продвижение</h5> 
                              <ul>  
                                <li>Реклама в социальных сетях (SMM)</li>
                                <li>SEO продвижение интернет магазина</li>
                                <li>Контекстная реклама</li>
                                <li>SEO аудит</li>
                                <li>Базовая оптимизация ресурса</li>
                              </ul>
                            </div>
                            <div class="col-12 col-xl-4 mt-4 mt-xl-0 mb-4 mb-xl-0">
                              <h5 class="mb-4">Разработка сайтов</h5> 
                              <ul> 
                                <li>Landing Page (одностраничный сайт)</li>
                                <li>Сайт визитка</li>
                                <li>Интернет магазин</li> 
                                <li>Корпоративный сайт</li>
                                <li>Сайт-каталог</li>
                                <li>Сайты на открытых платформах (Joomla, Wordpress, ModX)</li>
                                <li>Сайты на платформе Bitrix</li>
                              </ul>
                              
                              <h5 class="my-4">Разработка фото/видео контента, копирайтинг</h5> 
                              <ul> 
                                <li>Создание и обработка фото/видео контента</li>
                                <li>3D графика, компьютерная анимация</li>
                                <li>Монтаж видео</li> 
                                <li>Написание оригинальных текстов для сайта</li>
                                <li>Разработка интерактивных Веб-приложений</li>
                              </ul>
                            </div>
                            <div class="col-12 col-xl-4 mt-4 mt-xl-0 mb-4 mb-xl-0">
                              <h5 class="mb-4">Техническая поддержка</h5>
                              <ul>  
                              ...
                              <h5 class="my-4">Особые решения</h5>
                              <ul> 
                                <li>Разработка браузерных игр</li>
                                <li>Интеграция сайта с 1С</li>
                                <li>Интеграция с CRM Битрикс24</li>
                                <li>Подключение платёжных систем</li>
                                <li>Интеграция с соц.сетями</li>
                                <li>Создание корпоративной почты</li>
                              </ul>
                            </div>
                          </div>
                        </div>
