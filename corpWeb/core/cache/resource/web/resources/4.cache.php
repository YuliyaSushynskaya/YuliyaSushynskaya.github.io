<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1543388963,
    'editedby' => 1,
    'editedon' => 1543388967,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1543388940,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
        ...
        <content>
            <div class="col-12 col-xl-10 col-lg-10 float-xl-right float-lg-right bypro_content_wrapper">
                                    ...
                                    <div class="services_submenu">
                                      <ul>
                                        <li class="my-4 my-lg-1" name="software"><p name="software">Программное обеспечение</p><span></span><div class="special_contact active" id="light_software" name="software"></div></li>
                                        <li class="my-4 my-lg-1" name="equipment"><p name="equipment">Оборудование</p><span></span><div class="special_contact" id="light_equipment" name="equipment"></div></li>
                                      </ul>
                                    </div>
...
------------------------------------------------------------------------------------------------------------------------------------------->
<div  id="software_wrapper">                 
                  <!-- Описание -->
                  <div class="row">
                    <div class="col-12" name="software">
                        ...
                        <div class="col-10 col-md-8 mx-auto">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-lg-8">
                                <h1 class="software"><span style="display:inline-block" class="glitch" data-text="Программное">Программное </span> <span style="display:inline-block" class="glitch" data-text="обеспечение">обеспечение</span></h1>
                              </div>
                            </div>
...
--------------------------------------------------------- ОБОРУДОВАНИЕ --------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------->
<div id="equipment_wrapper">
                  <!-- Описание -->
                  <div class="row">
                    <div class="col-12" name="equipment">
                      ...
                      <div class="row">
                        <div class="col-10 col-md-8 mx-auto">
                            ...
                            <div class="row">
                              <div class="col-4 d-none d-lg-block"></div>
                              <div class="col-12 col-lg-8">
                                <h1 class="equipment glitch" data-text="Оборудование">Оборудование</h1>
                              </div>
                            </div>
