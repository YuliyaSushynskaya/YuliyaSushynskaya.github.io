...
(function() {
	...
	var leftButton = document.getElementsByClassName('about_slider_certificates_left')[0];
	var leftButtonI = document.getElementsByClassName('about_slider_arrow_left')[0];
	var rightButton = document.getElementsByClassName('about_slider_certificates_right')[0];
	var rightButtonI = document.getElementsByClassName('about_slider_arrow_right')[0];


	var tape = document.getElementById('about_certificates_ul'); 

	var left = 1, right = 1, step = 1;

	var parent_row = document.getElementsByClassName('about_slider_certificates_wrapper')[0]; 	// блок для сравнения ширины
	
	var parent_row_width = parent_row.getBoundingClientRect().width;							// ширина блока для сравнения
	var img_wrapper = document.getElementsByClassName('about_slider_certificates')[0];			// родительский блок для картинок
	...
	var img_mass = document.getElementsByClassName('img_certificates'); 						// массив картинок
